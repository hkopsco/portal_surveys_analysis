...
ggplot(data = total_ann_abund_spp, aes(x = year, y = n, color = species)) +
     ...
     labs(x = "Year of observation",
         y = "Number of species")
      fig.cap = "Total number of species observed each year"
```
...
```{r, include=FALSE}
# Relationship between annual species abundance and annual precipitation
...
```{r, include=FALSE}
# Relationship among precipitation and observation years
