...
ktest2 = kruskal.test(mean_weight ~ mean_hindfoot, data = means_for_top_five)

```

There is not significant relationship between species' mean weight between mean hindfoot length (p = `r ktest2$p.value`).
