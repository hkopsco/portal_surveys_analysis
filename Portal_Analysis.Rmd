...
A boxplot of the mean abundance per experimental plot reveals a large number of outliers. A Kruskal-Wallis one way test of variance reveals that there is a significant difference among the mean species abundances per plot_id (p = 5.559e-14).
...
*C. baileyi* and *D. merriami* are the most abundant species for all experimental plots, but there is a lot of variance in their sample numbers throughout the years.
...
There does not appear to be a significant relationship between the annual species abundance and the annual precipitation (p = 0.234).
...
Likewise, there is no significant difference among sampling years and the amount of precipitation (p = 1).

```{r echo=FALSE}

hist(precip_survey$precipitation)
summary(precip_yr)
